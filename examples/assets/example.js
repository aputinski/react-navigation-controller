...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationController = __webpack_require__(2);

	var _require = __webpack_require__(3);

	var ViewA = _require.ViewA;
	var ViewB = _require.ViewB;
	var ViewC = _require.ViewC;

	var a = React.createElement(ViewA, null);

	var b = React.createElement(ViewB, null);

	var c = React.createElement(ViewC, null);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var optionTypes = {
	  pushView: {
	    ...
	    transition: React.PropTypes.oneOfType([React.PropTypes.func, React.PropTypes.string]),
	...
	var NavigationController = (function (_React$Component) {
	  function NavigationController(props) {
	    ...
	    _get(Object.getPrototypeOf(NavigationController.prototype), "constructor", this).call(this, props);
	    var _props = this.props;
	    var views = _props.views;
	    var preserveState = _props.preserveState;
	  ...
	  _createClass(NavigationController, {
	    ...
	    __transformViews: {
	      ...
	      value: function __transformViews(prevX, prevY, nextX, nextY) {
	        ...
	        var prevView = this["__view-wrapper-" + prev];
	        var nextView = this["__view-wrapper-" + next];
	    ...
	    __animateViews: {
	      ...
	      value: function __animateViews() {
	        ...
	        var transition = arguments[1] === undefined ? "none" : arguments[1];
	    ...
	    __animateViewsComplete: {
	      ...
	      value: function __animateViewsComplete() {
	        ...
	        var prevViewWrapper = this["__view-wrapper-" + prev];
	        ...
	        this.setState({
	          ...
	          _this.__viewIndexes = _this.__viewIndexes[0] === 0 ? [1, 0] : [0, 1];
	        });
	      }
	    },
	    __displayViews: {
	    ...
	    __transitionViews: {
	      ...
	      value: function __transitionViews(transition, onComplete) {
	        var _this = this;

	        this.__transitionViewsComplete = function () {
	          delete _this.__transitionViewsComplete;
	        ...
	        if (typeof transition === "string") {
	          ...
	          if (transition === "none") {
	            ...
	            requestAnimationFrame(function () {
	              _this.__animateViewsComplete();
	              _this.__transitionViewsComplete();
	            });
	          }
	        ...
	        if (typeof transition === "function") {
	          ...
	          var prevView = this["__view-wrapper-" + prev];
	          var nextView = this["__view-wrapper-" + next];
	          transition(prevView, nextView, function () {
	            _this.__animateViewsComplete();
	            _this.__transitionViewsComplete();
	          });
	        }
	    ...
	    __pushView: {
	      ...
	      value: function __pushView(view, options) {
	        ...
	        this.setState({
	          ...
	          var prevView = _this.refs["view-0"];
	          if (prevView && _this.state.preserveState) {
	            // Save the state before it gets unmounted
	            _this.__viewStates.push(prevView.state);
	          }
	          // Transition
	          _this.__transitionViews(transition, onComplete);
	        });
	    ...
	    __popView: {
	      ...
	      value: function __popView(options) {
	        ...
	        this.setState({
	          ...
	          var nextView = _this.refs["view-1"];
	          if (nextView && _this.state.preserveState) {
	            var state = _this.__viewStates.pop();
	            // Rehydrate the state
	            if (state) {
	    ...
	    __setViews: {
	      ...
	      value: function __setViews(views, options) {
	        ...
	        var onComplete = options.onComplete;
	        var preserveState = options.preserveState;

	        options = assign({}, options, {
	          onComplete: function () {
	            _this.__viewStates.length = 0;
	            _this.setState({
	              views: views,
	              preserveState: preserveState
	            }, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewA = (function (_View) {
	  function ViewA(props) {
	    _classCallCheck(this, ViewA);

	    _get(Object.getPrototypeOf(ViewA.prototype), "constructor", this).call(this, props);
	    this.state = {
	      counter: 0,
	      color: "#001f3f"
	    };
	  ...
	  _inherits(ViewA, _View);

	  _createClass(ViewA, {
	    onNext: {
	      value: function onNext() {
	        this.props.navigationController.pushView(React.createElement(ViewB, null));
	      }
	    },
	    incrementCounter: {
	...
	var ViewB = (function (_View2) {
	  function ViewB(props) {
	    _classCallCheck(this, ViewB);

	    _get(Object.getPrototypeOf(ViewB.prototype), "constructor", this).call(this, props);
	    this.state = {
	      color: "#0074D9"
	    };
	  }

	  _inherits(ViewB, _View2);
	...
	var ViewC = (function (_View3) {
	  function ViewC(props) {
	    _classCallCheck(this, ViewC);

	    _get(Object.getPrototypeOf(ViewC.prototype), "constructor", this).call(this, props);
	    this.state = {
	      color: "#F012BE"
	    };
	  }

	  _inherits(ViewC, _View3);
	...
	(function () {
	    ...
	    advance: function advance(time, deltaTime) {
	      ...
	      for (var i = 0, len = this._activeSprings.length; i < len; i++) {
	        ...
	        if (spring.systemShouldAdvance()) {
	          spring.advance(time / 1000, deltaTime / 1000);
	        } else {
	  ...
	  util.extend(BouncyConversion.prototype, {
	    ...
	    b3Friction3: function b3Friction3(x) {
	      return 4.5e-7 * Math.pow(x, 3) - 0.000332 * Math.pow(x, 2) + 0.1078 * x + 5.84;
	    },
